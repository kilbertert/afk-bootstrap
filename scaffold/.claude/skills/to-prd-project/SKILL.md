...
This skill writes a PRD and publishes it as a GitHub issue in `__AFK_GITHUB_REPOSITORY__`. It does **not** apply `agent:implement` — labeling happens _after_ sub-issues have been created.
